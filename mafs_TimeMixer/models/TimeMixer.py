...
if __name__ == "__main__":
    ...
    x_mark_enc = torch.randn(B, T, 4)   # 假设你用了四维时间特征
    x_dec = torch.randn(B, configs.label_len + configs.pred_len, N)
    x_mark_dec = torch.randn(B, configs.label_len + configs.pred_len, 4)
