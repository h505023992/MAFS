...
model_name=iTrans_Cooperation

root_path_name=./dataset/
data_path_name=ZafNoo.csv
model_id_name=ZafNoo
data_name=custom
# seq_len=720
trap 'kill 0' EXIT
export CUDA_VISIBLE_DEVICES=7

# agent_root_name=./Forecasting_Agent_iTrans
# log_dir="${agent_root_name}/${data_name}/logs"
...
seq_len=$pred_len
  ...
  do
    for agent_num in 4 8 12 16 20 24
    do
    for mode in  'ring' 'chain' 'star'  'fully' 
    do
    agent_root_name="./Homo_Agent_Log/Forecasting_Agent_iTrans_${mode}"
